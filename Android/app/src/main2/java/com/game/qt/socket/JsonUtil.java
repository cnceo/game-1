...
public class JsonUtil {
    ...
    private static ObjectMapper mapper = new ObjectMapper().setDateFormat(new SimpleDateFormat(DATETIME_FORMAT)) // 日期格式化为 yyyy-MM-dd HH:mm:ss
            .setSerializationInclusion(Include.NON_EMPTY) // 创建只输出非Null且非Empty(如List.isEmpty)的属性到Json字符串的Mapper
